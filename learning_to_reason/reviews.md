...
* 疑問
    * T5 プロンプト
    * 内在的知識を必要とする推論はどうするか＝仮定をマスクして解かせる
    * 推論能力は大規模言語モデルに特有なのか
    * ruletaker datasetを無限に大きくしたら 転移性能が上がるか？
    * １つのモデルでできるか？
        - なぜselectorが必要なのか．
    * SIはfine-tuningはあまり詳しくやっていない．
    * なぜselectionが必要なのか？
...
* Pushing the Limits of Rule Reasoning in Transformers through Natural Language Satisfiability
    ...
    - ソースコード: https://github.com/allenai/language_fragments
...
* ProofWriter: Generating Implications, Proofs, and Abductive Statements over Natural Language
    ...
    * ソースコード
        ...
        * FaiRR に乗った方が良い．
* Pushing the Limits of Rule Reasoning in Transformers through Natural Language Satisfiability
    - 概要: RuleTakerのSAT版の公開．SATなので，証明過程は含まれていないことに注意．
    * ソースコード
